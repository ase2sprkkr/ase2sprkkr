...
Version 3.6.0
-------------
* SFN files readeding/writing/plotting
* SFNFIL value for explicit setting of SFN file
* Info, whether SFN is generated by SPR-KKR
* SCF parsing now supports runs without EMIN (thanks to Chriss Woodgate)

Internals
~~~~~~~~~
* Refactoring of repeated Values to allow more general usage
* Refactoring of validation to allow cross-section validation (e.g. lengths of arrays),
  validation is now fully transactional
* Numpy arrays with a given number of lines
