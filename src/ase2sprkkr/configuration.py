        ...
        Section(
            ...
            [
                V(
                    ...
                    default_value="auto",
                    info="Run empty spheres finding before calculation? Default value ``auto`` means only for SCF calculations not containing any vacuum atom.",
                ),
                V(
                    "print_output",
                    Keyword(
                    ...
                    default_value="info",
                    info="Print output of SPRKKR calculation. Default value ``info`` prints only short info each iteration.",
                ),
                V(
                    "mpi",
                    CustomMixed(Bool, Array(AlwaysQString.I), Integer.I),
                    is_optional=True,
                    default_value=None,
        ...
        Section(
            ...
            [
                ...
                V(
                    ...
                    AlwaysQString.I,
                    is_optional=True,
                    info="Directory, from which the executables will be runned. None mean use the default PATH-environment-variable mechanism.",
                ),
            ],
