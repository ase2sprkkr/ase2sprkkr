        ...
        TASK("Gilbert").copy(
            [
                V(
                    ...
                    int,
                    is_required=False,
                    info="Number of temperature points used for α(T)",
                ),
                V(
                    "SETFLUCT",
                    Keyword(
                ...
                V(
                    ...
                    int,
                    is_required=False,
                    info="Number of directions for atomic displacements"
                ...
                V(
                    ...
                    real,
                    is_required=False,
                    info="Lower limit of the temperature region (SETLFUNC=MLIN).",
                ),
                V(
                    "TMPMAX",
                    real,
                    is_required=False,
                    info="Upper limit of the temperature region (SETLFUNC=MLIN)",
                ),
                V(
                    "FLUCTFIL",
                    str,
                    is_required=False,
                    info="Data ﬁle which contains the information about "
                ...
                V(
                    ...
                    int,
                    is_required=False,
                    info="Number of grid points specifying θ angle (SETLFUNC=M_T)",
                ),
                V(
                    "NFPHI",
                    int,
                    is_required=False,
                    info="Number of grid points specifying φ angle (SETLFUNC=M_T)",
                ),
            ]
        ),
    ],
