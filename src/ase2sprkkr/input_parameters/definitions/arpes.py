...
input_parameters = lambda: InputParameters(
    ...
    [
        ...
        ENERGY(
            emin=(
                None,
                "Minimum of the energy window in eV with respect to the Fermi level",
                -8.0,
            ),
            emax=(
                None,
                "Maximum of the energy window in eV with respect to the Fermi level",
                5.0,
            ),
            add=[
                ...
                V(
                    "IMV_INI_EV",
                    0.05,
                    info="Imaginary part of the potential in eV (initial state)",
                ),  # alternatively you can use VIL (in eV) or IMV_INI (in Ry)'),
                V(
                    "IMV_FIN_EV",
                    2.0,
                    info="Imaginary part of the potential in eV (final state)",
        ...
        Section(
            ...
            [
                ...
                V(
                    "CRYS_VEC",
                    True,
                    info="Miller indices with respect to crystalographic primitive vectors",
                ),
                V(
                    "STRVER",
                    1,
        ...
        Section(
            ...
            [
                ...
                V(
                    "POL_P",
                    DefKeyword("P", "S", "C+", "C-"),
                    info="Polarization of the light",
                ),
                ...
                V(
                    "ALQ",
                    expert=45.0,
                    info="Alignment of polarization vector or pol.ellipsis",
                ),
                V(
                    "DELQ",
                    expert=0.0,
                ...
                V(
                    ...
                    float,
                    is_expert=True,
                    info="Light and electrons are at fixed polarization angle",
                ),
            ],
            info="",
        ),
        Section(
            ...
            [
                ...
                V(
                    "KA",
                    Range(float),
                    info="Scatering in momentum space ",
                    is_required=False,
                ),
                V(
                    "K1",
                ...
                V(
                    "NK1",
                    int,
                    info="Number of momentum steps for the integration",
                    is_required=False,
                ),
                V(
                    "K2",
                ...
                V(
                    "NK2",
                    int,
                    info="Number of momentum steps 2 for the integration",
                    is_required=False,
                ),
                V(
                    "K3",
                ...
                V(
                    "NK3",
                    int,
                    info="Number of momentum steps 3 for the integration",
                    is_required=False,
                ),
                V(
                    "K4",
                ...
                V(
                    "NK4",
                    int,
                    info="Number of momentum steps 4 for the integration",
                    is_required=False,
                ),
                ...
                V(
                    ...
                    Array(int, length=3),
                    expert=[0, 0, 0],
                    info="initial pol. in the laboratory system",
                ),
                V(
                    "Q1",
                    complex,
