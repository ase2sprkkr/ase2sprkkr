...
class TestSites(TestCase):
    ...
    def test_potential(self):
        a = SPRKKRAtoms("NaCl")
        m1 = ExponentialMesh(1.0, 0.005, None, None, 200, None)
        ...
        self.assertEqual(s0.potential(2.0), 2.0)
        self.assertEqual(s0.potential(1.0), 1.0)
        self.assertEqual(s0.potential(1.5), 1.5)
        self.assertEqual(s1.potential(2.0), 2.0)
        ...
        self.assertEqual(s0.potential(2.0), 4.0)
        self.assertEqual(s0.mesh, s1.mesh)
        ...
        self.assertEqual(s0.potential(2.0), 4.0)
        self.assertEqual(s0.potential(1.0), 2.0)
        self.assertEqual(s0.potential(1.5), 3.0)
        ...
        self.assertEqual(s0.mesh, s1.mesh)
        self.assertEqual(s0.charge(2.0), 6.0)
        self.assertEqual(s0.charge(1.0), 3.0)
        s0.potential = p2
    ...
    def test_occupancy(self):
        ...
        site.occupation[0] = 0.0
        self.assertEqual(0.0, site.occupation[0])
        self.assertAlmostEqual(0.3 * 5.0 / 4.0, site.occupation[1])
        self.assertAlmostEqual(0.5 * 5.0 / 4.0, site.occupation[2])
        self.assertEqual(3, len(site.occupation))
        site.occupation.clean()
        self.assertEqual(2, len(site.occupation))
        self.assertAlmostEqual(0.3 * 5.0 / 4.0, site.occupation[0])
        self.assertAlmostEqual(0.5 * 5.0 / 4.0, site.occupation[1])
    ...
    def test_occupancy_and_spacegroup_kinds(self):
        ciffile = "test2.cif"
        atoms = ase.io.read(os.path.join(os.path.dirname(__file__), ciffile))
